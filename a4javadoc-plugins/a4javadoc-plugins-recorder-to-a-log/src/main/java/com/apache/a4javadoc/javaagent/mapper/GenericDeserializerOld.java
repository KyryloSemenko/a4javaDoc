...
//            }
//            return invokeFactoryOrNonemptyConstructor(currentNode, parentInstance, fieldName, classForInstantiation, containerTypes, identifier);
//        } catch (Exception e) {
//            throw new AppRuntimeException(e);
//        }
//    }
...
//            } else {
//                List<Class<?>> genericTypes = IdentifierService.getInstance().findGenericTypes(identifier);
//                value = deserializeObject(valueFieldNode, clazz, genericTypes, identifier, parentInstance, fieldName);
//            }
...
//    private Object invokeFactoryOrNonemptyConstructor(JsonNode jsonNode, Object parentInstance, String fieldName, Class<?> clazz, List<Class<?>> containerTypes, String identifier) {
//        try {
//            Field field = null;
